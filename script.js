...
function addSocialMediaLinks(socialMedia) {
    ...
    if (!document.querySelector('.social-links')) {
        ...
        const socialIcons = {
            ...
            obra: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3L4 9v2c0 5.25 3.41 10.19 8 11.41 4.59-1.22 8-6.16 8-11.41V9l-8-6zm0 15.5c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5zM13 14h-2V8h2v6z"/></svg>'
        };

        Object.keys(socialMedia).forEach(platform => {
            if (socialMedia[platform] || platform === 'obra') {
...
if (logo) {
    logo.addEventListener('click', (e) => {
        // Only trigger if clicking near the top/left logo
        logoClicks++;
